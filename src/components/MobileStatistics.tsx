...
import { ChevronDown, ChevronUp, TrendingUp, Flame, Snowflake, Trophy, Star, Loader2 } from 'lucide-react';
import { LottoNumber } from '../types';
import { getLottoNumberColor } from '../utils/lottoGenerator';
import { WinningDraw } from '../hooks/useLottoWinning';
import { HotNumber, ColdNumber } from '../hooks/useLottoStatistics';

interface MobileStatisticsProps {
  history?: LottoNumber[];
  latestDraw?: WinningDraw | null;
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        {isExpanded && (
          <div className="border-t border-gray-100 p-4 space-y-4 animate-slide-up bg-gray-50/50">
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-1.5">
                    ...
                    <h4 className="text-xs font-bold">직전 당첨 번호 {latestDraw && `(${latestDraw.drwNo}회)`}</h4>
                  </div>
                </div>
                <div className="flex items-center gap-1 sm:gap-1.5 justify-center flex-wrap min-h-[32px]">
                  {!latestDraw ? (
            ...
            {/* 2. 역대 최다 출현 번호 TOP 5 */}
            <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm min-h-[140px]">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-1.5">
              ...
              <div className="space-y-2.5">
                {hotNumbers.length === 0 ? (
                  ...
                  hotNumbers.map(({ number: num, count }, index) => (
                      ...
                      <div className="flex-1 flex flex-col justify-center gap-0.5">
                        ...
                        <div className="w-full bg-gray-100 rounded-full h-1.5 overflow-hidden">
                          <div
                            ...
                            style={{ width: `${(count / hotNumbers[0].count) * 100}%` }}
                          />
                        </div>
                      </div>
                    </div>
            ...
            {/* 3. 장기 미출현 번호 */}
            <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm min-h-[120px]">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-1.5">
