import { Trophy, Flame, Snowflake, Star, Loader2 } from 'lucide-react';
    ...
    <div className="space-y-4">
      ...
      <div className="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl shadow-lg p-5 text-white relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center gap-1.5 justify-center mt-2 flex-wrap min-h-[32px]">
            {!latestDraw ? (
      ...
      {/* 2. 역대 최다 출현 번호 HOT 5 */}
      <div className="bg-white rounded-2xl shadow-lg p-5 border border-gray-100 min-h-[160px]">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
